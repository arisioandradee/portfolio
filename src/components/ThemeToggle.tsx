...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="fixed bottom-8 right-8 z-50 p-4 rounded-2xl bg-background/80 backdrop-blur-md border border-cyan-500/20 shadow-xl hover:scale-110 transition-all duration-300 group"
    >
